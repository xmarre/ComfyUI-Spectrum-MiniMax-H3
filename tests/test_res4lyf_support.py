...
@pytest.mark.parametrize("function_name", sorted(RES4LYF_ODE_SAMPLERS))
def test_reviewed_res4lyf_ode_variants_are_allowlisted_but_not_replayable(function_name):
