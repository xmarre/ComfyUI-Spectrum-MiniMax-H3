...
| RES4LYF multistep RES | `res_2m`, `res_3m` and `*_ode` | Full native startup stays exact; later stage-0 forecasts are isolated until 2/3 exact calls flush the persistent multistep history. |
